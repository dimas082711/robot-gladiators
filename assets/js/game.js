...
var fightOrSkip = function() {
  ...
  if (confirmSkip) {
    ...
    // subtract money form playerMoney for skipping, but dont let them go into negative
...
var fight = function(enemy) {
  ...
  while (playerInfo.health > 0 && enemy.health > 0) {
    if (isPlayerTurn) {
      ...
      playerInfo.health = Max.max(0, playerInfo.health - damage);
      console.log(
        enemy.name +
        "attacked" +
        playerInfo.name +
